...
class CommandRegistry {
  ...
  constructor() {
    ...
    this.register("ArrowUp", new NavigateBlockCommand("up"));
    this.register("ArrowDown", new NavigateBlockCommand("down"));
    this.register("ArrowLeft", new PreventNavigateOutCommand("left"));
