  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed bottom-4 right-4 h-10 w-10 rounded-full shadow-lg z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80"
      ...
      {/* Hotkeys panel */}
      {isOpen && (
        <div className="fixed bottom-16 right-4 w-80 max-h-[70vh] overflow-y-auto rounded-lg border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 shadow-lg z-50">
